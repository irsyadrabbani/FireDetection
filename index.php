                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="forgot-password.html">Need Help? RifkyAbdilah@gmail.com</a>
                                    </div>
          ...
          if($row == 1){
            ...
            if($cek_pass != $password){
              echo "<script>alert('Password salah');</script>";
               ...
               $_SESSION['login'] = true;
              echo "<script>alert('Login Berhasil');document.location.href='../firedetection/home.php'</script>";
            }
          }else{
